...
INITIAL_MESSAGE_OPEN = "You are an expert Python code developer."

ADDITIONAL_MESSAGE_OPEN= ("Provide an executable Python function for the given problem. No need to provide any explanation "
                          "or comments. Declare function variables as stated in the question and in the same order. Do "
                          "not use variable names like time, os or other existing python module names.")
...
COMPILE_ERROR = "The previous solution failed to compile. Can you please generate a solution that executes."

COMPILE_TIME_ERROR = "Code could not be compiled within 30s and was terminated. Possibly due to an infinite loop or order of the results. Please modify the code accordingly."
